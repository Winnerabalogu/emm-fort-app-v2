    ...
    <section className="py-12 bg-gradient-to-br from-gray-50 to-gray-100 py-20 overflow-hidden">
      <div className="container mx-auto pt-32 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-12 items-center">
          ...
          {/* Right Content - Social Media Stats - Order 3 on all screens */}
          <div className="order-3">
            <div className="space-y-6">
              {/* YouTube Stats */}
              <div className="bg-white rounded-lg shadow-lg p-4 flex items-center space-x-3 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <div className="text-right flex-shrink-0">
                  <p className="text-lg font-bold text-gray-900">1.5M+</p>
                  <p className="text-xs text-gray-600 pb-1">Subscribers</p>
                  <button className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-medium py-1 px-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                    Subscribe
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 flex items-center space-x-3 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <div className="text-right flex-shrink-0">
                  <p className="text-lg font-bold text-gray-900">800K+</p>
