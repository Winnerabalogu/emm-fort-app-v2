...
import { Lock, CreditCard, Eye, EyeOff, Shield, CheckCircle2, AlertCircle } from 'lucide-react';
...
const WithdrawalDetails = () => {
  ...
  const [message, setMessage] = useState<{ type: 'error' | 'success', text: string } | null>(null);
   ...
   useEffect(() => {
    fetch('/api/user/withdrawal-details') 
      .then(res => res.json())
      .then(data => {
        if (data && !data.error) {
          reset(data); 
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-500">Manage your account security and withdrawal information</p>
      </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Bank information required for processing withdrawals</p>
            </div>
          </div>
        </div>
        <div className="p-6">
          <div className="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-amber-800">
                <strong>Important:</strong> Ensure all information matches your bank records exactly. 
                Incorrect details may cause withdrawal delays.
              </p>
            </div>
          </div>
          <WithdrawalDetails />
